...
def predict():
    ...
    return render_template('upload.html',prediction=res,calories=calories,carbohydrate=carbohydrate,protein=protein,fat=fat,fibre=fibre,cholesterol=cholesterol,sodium=sodium,potassium=potassium)
